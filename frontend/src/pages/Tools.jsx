...
const apiEndpoints = [
  ...
  ['GET', '/api/v1/search', 'Authenticated', 'Search locations by name or Life Location Code', 'Bearer token with location:read; optional hierarchy filters', 'Search result[]'],
  ['GET', '/api/v1/duplicate-gn', 'Authenticated', 'Find duplicate GN names across DS divisions', 'Bearer token with location:read; optional province and district filters', 'Analysis rows and summary'],
